    ...
    <div class="container py-5 px-lg-5">
        <div class="row g-5">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <div class="row g-2">
                    <div class="col-4">
                        <img class="img-fluid" src="{{ url('template/img/portfolio-1.jpg') }}" alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="{{ url('template/img/portfolio-2.jpg') }}" alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="{{ url('template/img/portfolio-3.jpg') }}" alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="{{ url('template/img/portfolio-4.jpg') }}" alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="{{ url('template/img/portfolio-5.jpg') }}" alt="Image">
                    </div>
                    <div class="col-4">
                        <img class="img-fluid" src="{{ url('template/img/portfolio-6.jpg') }}" alt="Image">
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
